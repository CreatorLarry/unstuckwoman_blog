    ...
    >
        ...
        <div className="hero-overlay-two">
          <div className="hero-content container">
            ...
            <p className="hero-subtitle-two">
              You are not too much. You are not too late. You are exactly on
              time.
            </p>
        ...
        <div className="container">
          ...
          <div className="story-content">
            ...
            <ul>
              ...
              <li>
                Why can't I move forward, even though I know I was made for
                more?
              </li>
            </ul>
            <p>
              I was constantly shrinking myself, second-guessing my voice, and
              carrying pain I never paused to process. I was "functioning"...
              but far from free.
            </p>
            ...
            <p>
              ...
              journaling, falling down, rising again. I started healing patterns
              I didn't even know were running my life. I started meeting my real
            ...
            <ul>
              <li>
                "I feel like I'm the background character in my own life."
              </li>
          ...
          <div className="testimonials-grid">
            <div className="testimonial-card">
              ...
              <p>
                ...
                person at a time. Her coaching is timely and for such a season
                as this!!"
              </p>
      ...
      <section className="gallery-section" id="gallery">
        <div className="container">
          ...
          <div className="gallery-filters">
            ...
            <button className="filter-btn" data-filter="retreats">
              Retreats
            </button>
            <button className="filter-btn" data-filter="teambuilding">
              Team Building
            </button>
            <button className="filter-btn" data-filter="forums">
              Forums
            </button>
          </div>
          ...
          <div id="lightgallery" className="gallery-grid">
            ...
            {/* TEAM BUILDING */}
            <Link
              href="/images/team1.jpg"
              className="gallery-item teambuilding"
            >
              <Image
      ...
      <section className="contact-section" id="contact">
        <div className="container">
          ...
          <p className="section-subtitle">
            Book a free clarity call, ask a question, or just say hello — I'd
          ...
          <div className="contact-wrapper">
            ...
            <div className="contact-details">
              <p>
                <strong>Email:</strong>
                <Link href="mailto:mungaicoach@gmail.com">
                  mungaicoach@gmail.com
                </Link>
              </p>
              <p>
              ...
              <div className="social-icons">
                <Link
                  href="https://www.instagram.com/madgemungai"
                  target="_blank"
                >
                  <i className="fab fa-instagram"></i>
                </Link>
                <Link
                  href="https://www.facebook.com/madgemungai"
                  target="_blank"
                >
                ...
                <Link
                  href="https://www.tiktok.com/@madgemungai"
                  target="_blank"
                >
